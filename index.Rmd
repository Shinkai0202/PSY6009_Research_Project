...
![Figure 1. Degree of estimation bias over increasing task length estimates, with confidence intervals (1.96 times Standard Error). Values above 0 indicate overestimation, and below 0 indicate underestimation.](03_figures/bias%20over%20estimate%20-%20all.png)
...
![Figure 2. Mean absolute error over number of repetitions of a specific task over the previous 5.5 months.](03_figures/maleote.png)
...
If you would like to read the whole project with more detailed analysis and less interesting prose, and see the code I used, you can do so here: https://github.com/Shinkai0202/PSY6009_Research_Project 
